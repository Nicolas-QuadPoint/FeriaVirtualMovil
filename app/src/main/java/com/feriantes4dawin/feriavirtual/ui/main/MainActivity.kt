package com.feriantes4dawin.feriavirtual.ui.main
...
import com.feriantes4dawin.feriavirtual.ui.settings.SettingsActivity
import com.feriantes4dawin.feriavirtual.ui.util.FeriaVirtualConstants
import com.feriantes4dawin.feriavirtual.ui.widgets.YesNoDialog
...
class MainActivity : AppCompatActivity(){
    ...
    override fun onOptionsItemSelected(item: MenuItem) = when (item.itemId) {
        ...
        R.id.action_logout -> {
            ...
            val yesno = YesNoDialog(this,getString(R.string.err_mes_question),getString(R.string.err_msg_logout_prompt),
                {
